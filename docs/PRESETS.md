...
|--------|-----------------|------------|------|---------|-----------|----------------|--------|------------------|-----------|--------------|--------|
| `grain` | `25 / 27 / 29` | `6` | `0` | `0.10` | `true` | `1` | `5` | `hqdn3d=1.5:1.5:3:3` | `6` | `0` | Film-sourced or noisy captures: apply light denoising, then synthesize film grain for a balanced bitrate + "film look". |
