...
func NewProcessor(
	...
	srcCS := createColorspace(width, height, is10Bit, matrix, transfer, primaries, colorRange, chromaSamplePos)
	// Distorted (encoded) colorspace is always 10-bit for FFMS2 output
