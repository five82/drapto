"""Chunked encoding implementation for standard (non-Dolby Vision) content.

This module implements the chunked encoding pipeline used for standard content,
...
def encode_chunked(input_file: Path) -> Optional[Path]:
    """
    Encode standard (non-Dolby Vision) content using the chunked encoding pipeline.
    
    This function performs segmentation, parallel encoding (via segment_encoding),
    and concatenation.
