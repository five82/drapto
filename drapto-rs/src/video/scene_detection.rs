...
//! - Coordinating scene detection and boundary analysis
//! - Handling HDR/SDR threshold determination
//! - Managing scene detection workflow
//!
//! # Example
//! ```no_run
//! use std::path::Path;
//! use drapto::video::scene_detection::detect_scenes_with_config;
//! use drapto::config::Config;
//!
//! let config = Config::default();
//! let input_file = Path::new("video.mp4");
//! let scenes = detect_scenes_with_config(input_file, &config).unwrap();
